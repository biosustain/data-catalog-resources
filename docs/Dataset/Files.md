...
```{warning}
Currently, deleting a file permanently removes it from Data Catalog. However, files can still be **restored within 7 days** of deletion through the storage account. If you need to restore a file, please send us a message <a href="mailto:dinghe@dtu.dk?cc=pasdom@dtu.dk&subject=Data%20Catalog%20-%20File%20Restore%20Request&body=File%20name%3A%0A%0ADate%20deleted%3A%0A"><strong>here</strong></a>.
