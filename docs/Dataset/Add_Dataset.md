...
This guide walks you through the steps to create a new dataset in the Data Catalog, including:
* Upload files and directories, once the dataset is successfully submitted
