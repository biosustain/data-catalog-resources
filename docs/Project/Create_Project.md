...
```{tip}
Keep in mind that you can always update the project metadata at any time.
```
...
Click `Create project` in the ***bottom*** of the page to submit your project.


```{note}
There are also other fileds on the project creation page that are automatically generated by the platform, such as **Project Identifier**, **Data Created**, **Project Creator**, **Project Status**, **Access Rights**. These fields cannot be changed.
```
